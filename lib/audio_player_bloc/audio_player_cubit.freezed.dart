...
mixin _$AudioPlayerState {
  ...
  Duration get slider => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      isPlaying: null == isPlaying
          ...
          : isPlaying // ignore: cast_nullable_to_non_nullable
              as bool,
      audioExists: null == audioExists
          ? _value.audioExists
          : audioExists // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$AudioPlayerStateImpl implements _AudioPlayerState {
  const _$AudioPlayerStateImpl(
      ...
      this.slider = const Duration(seconds: 0),
  ...
  @override
  String toString() {
    return 'AudioPlayerState(animationController: $animationController, audioPlayer: $audioPlayer, duration: $duration, position: $position, slider: $slider, isPlaying: $isPlaying, audioExists: $audioExists, downloading: $downloading, playBackRate: $playBackRate, progress: $progress)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.audioExists, audioExists) ||
                other.audioExists == audioExists) &&
